...
/**
 * REST controller for managing {@link com.example.microservices.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
public class ShipmentResource {
    ...
    private static final String ENTITY_NAME = "microaShipment";
    ...
    public ResponseEntity<ShipmentDTO> updateShipment(@Valid @RequestBody ShipmentDTO shipmentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, shipmentDTO.getId()))
            .body(result);
    }
